...
class_name OPXVoiceDeck extends BaseVoiceDeck

const OPERATOR_SCENE := preload("res://gui/voices/operators/OPXOperatorDeck.tscn")

var _instantiated_operators: Array[OPXOperatorDeck] = []
...
func _update_knobs() -> void:
	...
	BaseVoiceDeck.setup_roller_knob(_feedback_knob, channel_data[OPXVoice.ChannelParam.FB])
	BaseVoiceDeck.setup_roller_knob(_algorithm_knob, channel_data[OPXVoice.ChannelParam.AL])
	...
	for i in voice.get_operator_count():
		var operator_deck: OPXOperatorDeck = null
