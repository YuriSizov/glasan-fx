...
class_name MA3VoiceDeck extends BaseVoiceDeck

const OPERATOR_SCENE := preload("res://gui/voices/operators/MA3OperatorDeck.tscn")
...
func _update_knobs() -> void:
	...
	BaseVoiceDeck.setup_roller_knob(_feedback_knob, channel_data[MA3Voice.ChannelParam.FB])
	BaseVoiceDeck.setup_roller_knob(_algorithm_knob, channel_data[MA3Voice.ChannelParam.AL])
	...
	for i in voice.get_operator_count():
		var operator_deck: MA3OperatorDeck = null
